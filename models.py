...
class Pergunta(db.Model):
    ...
    respostas = db.relationship('Resposta', backref='pergunta', lazy=True)  # Relacionamento com Respostas
...
class Resposta(db.Model):
    ...
    data_criacao = db.Column(db.DateTime, default=datetime.utcnow)
    autor_id = db.Column(db.Integer, db.ForeignKey('usuario.id'), nullable=False)
    pergunta_id = db.Column(db.Integer, db.ForeignKey('pergunta.id'), nullable=False)  # Relacionamento com Perguntas
